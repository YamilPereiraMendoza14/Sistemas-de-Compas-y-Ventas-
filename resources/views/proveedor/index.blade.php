...
<main class="main">
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$prov->email}}</td>
                            <td>
                                <button type="button" class="btn btn-info btn-md" data-id_proveedor="{{$prov->id}}" data-nombre="{{$prov->nombre}}" data-tipo_documento="{{$prov->tipo_documento}}"  data-num_documento="{{$prov->num_documento}}"
                                data-direccion="{{$prov->direccion}}"
                                data-telefeno="{{$prov->telefeno}}"
                                data-email="{{$prov->email}}"
                                data-toggle="modal" data-target="#abrirEditarProveedor">
    ...
    <div class="modal fade" id="abrirEditarProveedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-primary modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
